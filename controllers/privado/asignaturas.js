        ...
        JSON.dataset.forEach(row => {
            ...
            TBODY_ROWS.innerHTML += `
                ...
                <td>${row.id_asignatura}</td>
                    ...
                    <td>
                    <button onclick="openUpdate(${row.id_asignatura})"  type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    Actualizar
                    </button>
                    <button onclick="openDelete(${row.id_asignatura})" type="button" class="btn btn-danger">Eliminar</button>
                    </td>
                </tr>
            `;      
        });
