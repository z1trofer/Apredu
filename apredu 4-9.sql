...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-09-2023 a las 22:48:55
...
INSERT INTO `cargos_empleados` (`id_cargo`, `cargo`, `create_usuarios`, `update_usuarios`, `create_estudiantes`, `update_estudiantes`, `update_notas`, `view_notas`) VALUES
(1, 'admin', 0, 0, 0, 0, 0, 0),
...
(1, 'Primer trimestre', 1, 0),
(2, 'Segundo trimestre', 1, 1),
...
--
ALTER TABLE `cargos_empleados`
  MODIFY `id_cargo` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id del cargo', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `detalle_asignaturas_empleados`
--
ALTER TABLE `detalle_asignaturas_empleados`
  MODIFY `id_detalle_asignatura_empleado` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id del detalle de la asignatura y empleado', AUTO_INCREMENT=60;
